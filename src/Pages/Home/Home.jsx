        ...
        <>
            ...
            <section className='relative isolate overflow-hidden min-h-screen bg-[#d9d9d9]'>
                ...
                <div className='mx-auto max-w-sm lg:max-w-7xl'>
                    ...
                    <div className="absolute h-screen inset-0 top-0 z-30 left-0 rounded-md md:left-1/2 drop-shadow-lg backdrop-blur-sm  max-w-full lg:max-w-7xl bg-black/20">
                        <div className="px-3 py-3 md:px-4 md:py-4">
                            ...
                            <form noValidate className='space-y-1'>
