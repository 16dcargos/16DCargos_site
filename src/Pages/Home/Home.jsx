    ...
    return (
        <>
            ...
            <section className='relative isolate overflow-hidden min-h-screen bg-[#d9d9d9]'>
                <div className="">
                    <Img src={'https://res.cloudinary.com/dmh7fwdzf/image/upload/v1725907993/CTAedit_yhxora.png'} alt="Background Image" className="absolute inset-0 object-cover object-center w-full h-full" />
