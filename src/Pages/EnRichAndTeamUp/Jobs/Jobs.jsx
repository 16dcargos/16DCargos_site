    ...
    return (
        <React.Fragment>
            <section className="relative isolate flex overflow-hidden h-screen bg-custom">
                    ...
                    <div className="mb-20 mt-40 px-4 sm:max-w-xl md:max-w-full md:px-24 lg:ml-auto lg:max-w-screen-md lg:px-8">
                        <div className="flex flex-col items-center justify-between lg:flex-row">
                            <div className="max-w-xl text-center lg:max-w-lg lg:pr-5 lg:text-left">
                                <h2 className="mb-6 max-w-lg text-3xl leading-snug tracking-tight text-[#C96202] sm:text-5xl sm:leading-snug">
                                    <span className="my-1 inline-block font-serif font-bold text-[#C96202]">Learning model</span>
                                    of the future
                                </h2>
                                ...
                                <div className="mt-8 hidden flex-col justify-center sm:flex-row sm:items-center sm:space-x-4 lg:justify-start">
                                    <button className="relative mt-4 rounded-lg border-2 border-[#C96202] bg-[#C96202] px-6 py-2 font-medium text-white transition hover:translate-y-1">
                                        <div className="absolute left-0 -bottom-10 hidden h-10 w-10 -rotate-12 -scale-x-100 text-[#C96202] md:inline-flex">
                                    ...
                                    <button className="mt-4 flex items-center justify-center rounded-lg border-2 border-[#C96202] px-6 py-2 font-medium text-[#C96202] transition hover:translate-y-1 hover:bg-white">
                ...
                <div className="relative my-auto hidden h-full bg-green-50 text-[#C96202] lg:block lg:w-3/12 xl:w-5/12">
