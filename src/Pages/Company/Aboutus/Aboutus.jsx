            ...
            <section className='relative overflow-hidden isolate bg-[#d9d9d9] min-h-dvh'>
                ...
                <div className="relative inset-x-0 z-10 flex justify-center md:justify-start items-center h-screen top-1/4 lg:left-11">
                    <div className="max-w-sm md:max-w-xl lg:max-w-5xl px-4 py-4 md:px-8 space-y-6">
                        ...
                        <p className='max-w-md md:text-start text-center text-white font-Poppins font-normal text-[0.65rem] tracking-wide leading-6 '>Lorem ipsum dolor sit amet consectetur. Risus nulla vulputate lobortis aliquet odio aliquam lectus viverra. Lorem fames dui sit quam.</p>
            ...
            <div className="relative isolate overflow-hidden bg-custom">
                <div className="py-24 px-8 max-w-5xl mx-auto flex flex-col md:flex-row gap-12">
                    ...
                    <ul className="basis-1/2">
                        ...
                        <li>
                            <Link className='text-orange-500 mt-3 inline-flex font-normal no-underline group px-2 py-2 items-center -tracking-tight'>
                                See more
