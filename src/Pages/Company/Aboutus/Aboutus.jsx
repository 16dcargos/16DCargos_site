            ...
            <section className='relative overflow-hidden isolate bg-[#d9d9d9] min-h-dvh'>
                ...
                <div className="relative inset-x-0 z-10 flex justify-center md:justify-start items-center h-screen top-1/4 lg:left-11">
                    <div className="max-w-sm md:max-w-xl lg:max-w-5xl px-4 py-4 md:px-8 space-y-6">
                        <h1 className="text-white font-bold lg:max-w-2xl tracking-wide text-sm text-center md:text-start md:text-   xl lg:text-2xl font-Poppins leading-6">We are shaping the future of logistics, committed to elevating your experience and delivering excellence nationwide.</h1>
                        ...
                        <div className="flex justify-center md:justify-normal items-center">
                            <Link className="bg-[#C96202] text-white absolute mt-12 active:translate-y-[6px] py-2.5 px-5 rounded-full text-xs font-medium tracking-wider font-Poppins transition duration-300 ease-in-out transform  hover:shadow-custom-white">Get a Quote</Link>
                        </div>
                ...
                <div className="mx-auto max-w-md md:max-w-5xl py-6 px-4">
                    <div className="px-3 py-3 md:px-6 md:py-6 grid grid-cols-1 gap-0 md:gap-10 md:grid-cols-12">
                        <div className="py-4 md:col-span-7">
                            ...
                            <p className='text-xxs text-black tracking-wider leading-5  md:max-w-md mt-4 font-normal font-Poppins'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Recusandae quibusdam temporibus, mollitia atque, adipisci optio eligendi praesentium id sed quasi odit. Autem, explicabo? Modi minus asperiores laudantium repellendus esse quidem!</p>
                        </div>
                        <div className="py-5 md:col-span-5">
                            <form noValidate className='space-y-2'>
                                <div className='block relative'>
                                    <input type="email" id='email' placeholder='Email' name='email' className="placeholder:text-[8px] focus:shadow-custom-white focus:shadow-gray-400 transition-all ease-in-out duration-300 placeholder:tracking-wide w-full focus:outline-none font-Poppins text-xs rounded-md border py-2 px-3 bg-white text-black border-none" />
                                ...
                                <div className="">
                                    <button type='submit' className="bg-[#C96202] hover:shadow-gray-400 text-white active:translate-y-[6px] py-2 absolute z-10 px-6 rounded-lg text-xs font-medium tracking-wider font-Poppins flex justify-center items-center gap-2 transition duration-300 ease-in-out transform  hover:shadow-custom-white">
